initMap = !1,
    function(e) {
        ...
        ! function(f) {
            ...
            var e = function() {
                f("body").removeClass("loader-loading").off(".pageLoader"), f(window).trigger("resize").trigger("scroll")
            };
            f(window).on("load.pageLoader", e), setTimeout(e, 6e4), f("body").pexInit(), f(".menu-items .toggle-icon").on("click", function() {
                ...
                if (o.owlResponsive) {
                    for (var a = o.owlResponsive.split(";"), n = {
                            0: 1
                        }, s = [0, 768, 992, 1200], r = 0; r < s.length && r < a.length; r++) a[r] && (n[s[r]] = {
                ...
                if (o.owlSectionArrows) {
                    ...
                    c.length ? (l.nav = !0, l.navContainer = c[0], l.navText = ['<i class="fas fa-angle-left" aria-hidden="true"></i>', '<i class="fas fa-angle-right" aria-hidden="true"></i>']) : l.nav = !1
                }
                i.owlCarousel(l)
                ...
                var n, s = f(a).offset().top + f(a).outerHeight(),
                    ...
                    o = function(e, t) {
                        ...
                        o.removeClass("sticked-menu"), o.css("height", ""), s = i.offset().top + i.outerHeight(), c = !!(l && s < r) && (o.height(o.height()).addClass("sticked-menu"), s -= i.outerHeight(), !0), e || f(window).trigger("resize", ["skipCheck"])
                    };
                f(window).on("scroll", function() {
                    var e = f(window).scrollTop(),
                        t = e - r;
                    i = Math[0 < t ? "max" : "min"](i, 0) + t, r = e, c && (r <= s || 50 <= i) ? o(!1, !1) : !c && i <= -100 && o(!0, !0)
                }), f(window).on("resize", function(e, t) {
                    r = f(window).scrollTop(), "skipCheck" !== t && (n = setTimeout(function() {
                        o(!0)
                    }, 50))
                })
                ...
                a.length && "undefined" != typeof FileReader && (a.find(".file-preview-image img") && a.addClass("has-file"), a.find(".file-preview").on("click", function(e) {
                    e.preventDefault(), i.trigger("click")
                }), (l = new FileReader).onloadstart = function() {
                    a.removeClass("has-file")
                }, l.onload = function(e) {
                    a.find(".file-preview-image").empty().html('<img src="' + e.target.result + '" alt="" />'), a.addClass("has-file")
                ...
                a.on("click", function(e) {
                    ...
                    f(window).trigger("resize"), o.find(".shuffle-empty").css("display", l.visibleItems ? "none" : "block")
                })
            });
            var c = ["min", "max"],
                d = function(e, o) {
            ...
            f("[data-ui-range-slider]").each(function(e, t) {
                for (var i = f(t), o = i.find(".slider-container"), l = i.find("[data-slider-from]"), a = i.find("[data-slider-to]"), n = i.data(), s = {
                    ...
                    }, r = 0; r < c.length; r++) n.hasOwnProperty(c[r]) && (s[c[r]] = n[c[r]]);
                o.slider(s)
            ...
            t(), f(window).on("scroll resize orientationchange focus", t), f(".scroll-top").on("click", function(e) {
                e.preventDefault(), f("html, body").animate({
                    scrollTop: 0
                }, 1e3)
                ...
                f(".gmap").each(function(e, t) {
                    ...
                    }), n.mapTypes.set("styled_map", s), n.setMapTypeId("styled_map"), f(window).on("resize", function() {
